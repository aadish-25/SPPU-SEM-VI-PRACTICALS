...
def main():
    ...
    intents = {
        ...
        "drinks": {
            "examples": ["drinks", "coffee", "juice", "beer"],
            "responses": [
                "We serve soft drinks, juices and coffee.",
                "Our drinks menu includes fresh juices and mocktails.",
            ],
        },
        "reservation": {
        ...
        "location": {
            "examples": ["location", "address", "contact", "located"],
            "responses": [
        ...
        "timing": {
            "examples": ["timing", "open", "close", "hours"],
            "responses": [
        ...
        "delivery": {
            ...
            "responses": [
                ...
                "You can order using Swiggy and Zomato.",
            ],
        },
        "payment": {
